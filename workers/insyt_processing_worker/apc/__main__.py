...
def build_parser() -> argparse.ArgumentParser:
    ...
    azure.add_argument("--review-account", default=None, help="Review output storage account. Defaults to INSYT_REVIEW_STORAGE_ACCOUNT or insytreviewstorage")
    ...
    azure_upload = sub.add_parser("azure-upload-review", help="Upload local review-ready source/native and source/text outputs to insytreviewstorage. Requires --azure-write.")
    ...
    azure_run.add_argument("--azure-write", action="store_true", help="Required before review-ready outputs/reports are uploaded to insytreviewstorage")
