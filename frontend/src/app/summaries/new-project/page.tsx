...
export default function NewProjectPage() {
  ...
  const [fieldSelections, setFieldSelections] = useState<
    Record<string, "Text summaries" | "Tag" | "">
  >({});
  ...
  function selectTemplate(templateName: string) {
    ...
    const defaults: Record<string, "Text summaries" | "Tag" | ""> = {};
  ...
  function addNewDataElement() {
    ...
    updateFieldSelection(key, "Text summaries");
  }
    ...
    return selectedFields
      ...
      .map((field) => {
        ...
        return {
          ...
          format: currentValue || "Text summaries",
          notes: field.notes || "",
        };
      });
  }
                            ...
                            <td className="p-3">
                              <div className="flex gap-2">
                                <button
                                  ...
                                  className={
                                    currentValue === "Text summaries"
                                      ? normalizeDefaultFormat(field.default_format || "") === "Text summaries"
