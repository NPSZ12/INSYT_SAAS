...
function BatchesPageContent() {
  ...
  function createStatisticalQCBatches() {
    ...
    apiPost(`/api/summaries/projects/${encodeURIComponent(projectId)}/batches/create?client=${encodeURIComponent(clientId)}`, {
      batch_size:
        docsPerBatch === "Custom"
    ...
    <AppShell>
      <PageContainer>
        <PageHeader
          ...
          subtitle={`Create and manage Summaries batches for ${
            clientId
