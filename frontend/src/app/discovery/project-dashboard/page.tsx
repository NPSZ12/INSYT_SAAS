  ...
  return (
    <AppShell>
      <PageContainer>
        <PageHeader
          title={projectName}
          subtitle="Use the sidebar to access Batches, Review, discoveryd Entities, Timesheet, and Messaging."
        />
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <ContentCard title="Reviewer Workflow">
            <p className="text-slate-400">
              ...
              discoveryd Entities will show only your discoverys for your active batch.
            </p>
          </ContentCard>
        </div>
      </PageContainer>
