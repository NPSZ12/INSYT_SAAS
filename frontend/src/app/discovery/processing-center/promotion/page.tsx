...
const FOLDERS: FolderDefinition[] = [
  {
    ...
    description:
      "Worksheet-derived CSVs and other CSV data containing responsive elements. These records are routed to the CyberÂ² data workflow rather than ordinary document review.",
  },
  {
    key: "review_hits",
  ...
  try {
    ...
    for (
      ...
      if (failedCount > 0) {
        ...
        throw new Error(
          "Workbook promotion to Files did not complete successfully. Nothing was sent to CyberÂ²."
        );
      }
    }
    ...
    // register the selected documents in CyberÂ².
    //
    const response =
      await apiPost(
        `/api/${encodeURIComponent(
    ...
    if (skippedCount > 0) {
      console.warn(
        "CyberÂ² registration completed with skipped documents:",
        response
      );
    }
    ...
    if (sentCount === 0) {
      setError(
        response?.message ||
          "No documents were sent to CyberÂ²."
      );
    }

  } catch (err: any) {
    console.error(
      "Failed to promote spreadsheet files and send to CyberÂ²:",
      err
    );

    setError(
      err?.message ||
        "Unable to promote the selected files and send them to CyberÂ²."
    );
        ...
        <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
          ...
          <div>
            ...
            <p className="max-w-5xl text-sm leading-6 text-slate-400">
              ...
              data is separated for CyberÂ² processing, ordinary
        ...
        {initialLoading ? (
          ...
          <div className="space-y-6">
            ...
            <PromotionSection
              ...
              title="Spreadsheet / CSV Hits"
              description="Responsive spreadsheet data routed to CyberÂ². Worksheet-derived CSV children remain linked to their preserved source workbook."
              count={
                spreadsheetHitCount
              }
              icon={
              ...
              headerActions={
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  >
                    ...
                    {sendingCyber2
                      ? "Promoting & Sending..."
                      : "Promote to Files & Send to CyberÂ²"}
                  </button>
              ...
              headerActions={
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  >
                    ...
                    {promotingReview
                      ? "Promoting to Review & Generating AI Extraction..."
                      : "Promote to Review & Generate AI Extraction"}
                  </button>
