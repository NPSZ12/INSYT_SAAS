...
export default function discoveryPage() {
  ...
  return (
    <AppShell>
      <PageContainer>
        <PageHeader
          title="INSYT discovery"
          subtitle="Project intake, batching, review, entity discovery, and export workflows."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <ContentCard title="discoveryd Entities">
            <p className="text-slate-400 mb-4">
              View extracted/discoveryd entities and quality-control outputs.
            </p>
            <Button onClick={() => router.push("/discoveryd-entities")}>
              Open Entities
            </Button>
          </ContentCard>
