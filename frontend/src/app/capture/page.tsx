  ...
  return (
    <AppShell>
      <PageContainer>
        <PageHeader
          title="INSYT Capture"
          subtitle="Project intake, batching, review, entity capture, and export workflows."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <ContentCard title="Captured Entities">
            <p className="text-slate-400 mb-4">
              View extracted/captured entities and quality-control outputs.
            </p>
            <Button onClick={() => router.push("/captured-entities")}>
              Open Entities
            </Button>
          </ContentCard>
